...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "malloc_size_of" = rec {
        crateName = "malloc_size_of";
        version = "0.1.1";
        edition = "2021";
        sha256 = "04xah660p9s5sd3jg7d9p3b7q9i53d6ax4l1rwl008wgigg1kmz5";
        authors = [
      ...
      "smallvec" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "extract_if" "malloc_size_of" "may_dangle" "serde" "specialization" "std" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "2.0.117";
